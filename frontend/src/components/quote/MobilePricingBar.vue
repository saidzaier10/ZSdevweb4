    ...
    >
      <div class="px-4 py-3 flex items-center justify-between gap-4">
        <div class="flex items-center gap-2 min-w-0">
          ...
          <span class="text-xs text-gray-600 truncate">Estimation</span>
        </div>
        ...
        <div v-else-if="pricing" class="flex items-center gap-3">
          <div class="text-right">
            <div class="text-xs text-gray-600">HT</div>
      ...
      <Transition name="expand">
        <div v-if="expanded && pricing" class="px-4 pb-4 space-y-2 border-t border-gray-100 pt-3">
          ...
          <div class="border-t border-gray-100 pt-2 flex justify-between text-sm text-gray-600">
